...
function EditClientModal({
    ...
    const [editedIsCompanyOrder, setEditedIsCompanyOrder] = useState(
        client?.gstNumber || ""
    );
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50 mt-10 bg-black bg-opacity-50">
            <div className="relative overflow-auto max-h-[80vh] p-4 md:p-8 w-11/12 md:w-4/12 sm:px-4 bg-slate-200 dark:bg-slate-900 rounded-lg z-99">
                <div className=" sm:max-h-48 lg:max-h-125 ">
                    ...
                    <div className="mb-2 sm:mb-4 dark:text-slate-50">
                        ...
                        <select
                            ...
                            onChange={(e) =>
                                setEditedSalutation(e.target.value)
                            }
                    ...
                    <div className="mb-2 sm:mb-4">
                        ...
                        <select
                            ...
                            onChange={(e) =>
                                setEditedClientType(e.target.value)
                            }
                            className="mt-1 py-2 px-3 sm:px-4 focus:ring-red-600 focus:border-red-600 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md dark:text-white dark:border-neutral-500 dark:bg-slate-700 dark:focus:ring-neutral-400">
                    ...
                    <div className="mb-2 sm:mb-4">
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setEditedEmailAddress(e.target.value)
                            }
                            className="mt-1 py-2 px-3 sm:px-4 focus:ring-red-600 focus:border-red-600 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md dark:text-white  dark:border-neutral-500 dark:bg-slate-700 dark:focus:ring-neutral-400"
                        />
                    </div>
                        ...
                        {editedIsCompanyOrder && (
                            <>
                                ...
                                <input
                                    ...
                                    className="rounded-md py-2 px-3 focus:border-red-500 dark:border-neutral-500 dark:bg-slate-700"
                                    onChange={(e) =>
                                        setEditedGstNumber(e.target.value)
                                    }
                    ...
                    <div className="flex items-center my-3">
                        <input
                            ...
                            onChange={(e) =>
                                setEditedIsCompanyOrder(e.target.checked)
                            }
