            ...
            {products.map((product) => (
              ...
              >
                ...
                <td className="px-3 py-2">
                  {product.images &&
                  product.images.find(
                    (image) => image.imageName === "image1.jpg"
                  )
                    ? product.images.map((image) => {
                        if (image.imageName === "image1.jpg") {
                          return (
                            <img
                              key={image.imageId}
                ...
                <td className="px-3 py-2">
                  {product.images &&
                  product.images.find(
                    (image) => image.imageName === "image2.jpg"
                  )
                    ? product.images.map((image) => {
                        if (image.imageName === "image2.jpg") {
                          return (
                            <img
                              key={image.imageId}
                              src={`data:image/jpeg;base64,${image.imageData}`}
                ...
                <td className="px-3 py-2">
                  {product.images &&
                  product.images.find(
                    (image) => image.imageName === "image3.jpg"
                  )
                    ? product.images.map((image) => {
                        if (image.imageName === "image3.jpg") {
                          return (
                            <img
                              key={image.imageId}
                              src={`data:image/jpeg;base64,${image.imageData}`}
