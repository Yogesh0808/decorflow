...
const EditSofaOrderForm: React.FC<EditSofaOrderFormProps> = ({
  ...
  const [formData, setFormData] = useState<any>({
    ...
    image: null, // You may want to provide an option to update the image or keep it as is
    fabricNameCode: selectedProduct.fabricNameCode,
    fimg: null, // You may want to provide an option to update the fabric image or keep it as is
    sofaLeg: selectedProduct.sofaLeg,
    limg: null, // You may want to provide an option to update the leg image or keep it as is
