...
const Headboard: React.FC<WallpaperFormProps> = ({
    onCloseModal,
    selectedCustomer,
}) => {
    const [formData, setFormData] = useState<any>({
        ...
        sizeOfHeadboard: "",
        headboardFabricCode: "",
        headboardFabricImage: null,
        headboardReferencesImage: null,
        headboardSightImage: null,
        remarks: "",
    });
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        console.log("Headboard handleSubmit Called!");
        e.preventDefault();
        try {
            setLoading(true);
            ...
            formDataToSend.append("category", "Headboard");
            ...
            toast.error("Headboard Order has been cancelled", {
                position: "top-center",
                autoClose: 3000,
                hideProgressBar: true,
                closeOnClick: true,
                ...
                <form
                    ...
                    <div className="grid gap-4 mb-4 grid-cols-1 md:grid-cols-2">
                        ...
                        <div className="col-span-2 md:col-span-1">
                            ...
                            <input
                                ...
                                onChange={handleInputChange}
                                className="bg-slate-50 border border-slate-300 text-slate-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-slate-600 dark:border-slate-500 dark:placeholder-slate-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Enter Size of Headboard"
                            />
                        </div>
                        <div className="col-span-2 md:col-span-1">
                            <label
                    ...
                    <div className="grid gap-4 mb-4 grid-cols-1 md:grid-cols-2">
                        ...
                        <div className="col-span-2">
                            ...
                            <input
                                type="file"
                                id="headboardFabricImage"
                                name="headboardFabricImage"
                                accept="image/*"
                        ...
                        <div className="col-span-2">
                            ...
                            <input
                                type="file"
                                id="headboardReferencesImage"
                                name="headboardReferencesImage"
                                accept="image/*"
                                onChange={handleFileInputChange}
                                className="block p-2.5 w-full text-sm text-slate-900 bg-slate-50 rounded-lg border border-slate-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-slate-600 dark:border-slate-500 dark:placeholder-slate-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            />
                        ...
                        <div className="col-span-2">
                            ...
                            <input
                                type="file"
                                id="headboardSightImage"
                                name="headboardSightImage"
                                accept="image/*"
                                onChange={handleFileInputChange}
                                className="block p-2.5 w-full text-sm text-slate-900 bg-slate-50 rounded-lg border border-slate-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-slate-600 dark:border-slate-500 dark:placeholder-slate-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            />
