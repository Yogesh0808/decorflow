          ...
          <div className="grid gap-4 mb-4 grid-cols-1 md:grid-cols-2">
              ...
              <input
                ...
                onClick={() => {
                  if (formData.width !== "") {
                    ...
                    let widthInch = convertUnit(formData.width, unit, "inches");
                    let noPanels: number = Math.ceil(widthInch / 20);
                    setFormData({
                      ...formData,
                      noOfPanels: noPanels,
                    });
            ...
            <div
              ...
              onClick={() => {
                ...
                if (formData.height !== "") {
                  ...
                  let heightInch = convertUnit(formData.height, unit, "inches");
                  let heightTen = heightInch + 10;
                  let heightTwen = heightInch + 20;
                  let tenMtr = convertUnit(heightTen, "inches", "meter");
                  let twenMtr = convertUnit(heightTwen, "inches", "meter");
                  setFormData({
                    ...formData,
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              >
                ...
                <option value="Battery motor">Battery motor</option>
                <option value="Wired motor">Wired motor</option>
                <option value="Tubular motor">Tubular motor</option>
              </select>
            </div>
            <div className="col-span-2 md:col-span-1">
              <label
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <datalist id="tracksLists">
                <option value="dolphinr track">dolphinr track</option>
                ...
                <option value="Silent Track">Silent Track</option>
              </datalist>
            </div>
          </div>
          <hr className="my-4" />
